...
import "./Navbar.css";
import logo from "../assets/flipkart_logo.png"; // Path to your logo image

const Navbar = () => {
  return (
    <nav className="navbar-menu d-flex justify-content-between align-items-center">
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="nav-links d-flex align-items-center">
          ...
          <a href="/category/Headphone">Audio</a>
