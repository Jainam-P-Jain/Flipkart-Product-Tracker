...
const Navbar = ({ onSelectCategory }) => {
  return (
    <nav className="navbar sticky-top navbar-menu d-flex justify-content-between align-items-center">
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="nav-links d-flex align-items-center">
          <Link to="/explore" onClick={() => onSelectCategory("")}>Explore</Link>
          <Link to="/explore/watch">Watch</Link>
          <Link to="/explore/phone">Phone</Link>
        </div>
      </div>
